...
--  
 ...
 ON u.id = a.user_id
 SET u.age = u.age + 10
 WHERE a.user_id IS NOT NULL AND a.town = town AND a.address = address;
...
UPDATE addresses
SET country = CASE
WHEN LEFT(country, 1) = 'B' THEN country = 'Blocked'
WHEN LEFT(country, 1) = 'T' THEN country = 'Test'
WHEN LEFT(country, 1) = 'P' THEN country = 'In Progress'
END;
